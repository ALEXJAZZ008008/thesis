\chapter{Introduction} \label{sec:introduction}
    ...
    \longsection{Motivation}{sec:motivation}
        ...
        %ACW done
        \gls{PET}/\gls{CT} is a hybrid medical imaging modality which combines \gls{PET}, a functional imaging technique used to capture data related to the internal metabolic processes of a subject, with an anatomical imaging modality called \gls{CT}. Every year in the UK just over $150,000$ \gls{PET}/\gls{CT} scans are performed, the majority of these scans are used in the diagnosis and treatment of cancer~\parencite{NHSEngland2019Diagnostic2019/20}.
