\chapter{Introduction} \label{sec:introduction}
    ...
    \section{Motivation} \label{sec:motivation}
        ...
        \subsection{Objectives of this Work} \label{sec:objectives_of_this_work}
            The aim of this project is to formulate a method which produces \gls{PET}/\gls{CT} images which are corrected for respiratory motion and are automatically aligned between \gls{PET} and \gls{CT} data. This will be achieved through \gls{DDG} and motion modelling. %KT I'd replace IR with MM %ACW done
    ...
    \section{Overview of this Thesis} \label{sec:overview_of_this_thesis}
        ...
        The final chapter~\Fref{sec:discussion_and_conclusion} of this thesis concludes the previous chapters before critiquing and highlighting and motivating the future work to be performed.

        
        Work which was conducted during the writing of this thesis but which did not contribute to the overall narative of the the thesis can be seen in~\Fref{sec:pseudo_bayesian_dip_denoising_as_a_preprocessing_step_for_kinetic_modelling_in_dynamic_pet_appendix}, \Fref{sec:a_bayesian_neural_network-based_method_for_the_extraction_of_a_metabolite_corrected_arterial_input_function_from_dynamic_pbr28_pet_appendix}, and~\Fref{sec:deep_learning_for_ct_based_survival_analysis_of_idiopathic_pulmonary_fibrosis_patients_appendix}.
