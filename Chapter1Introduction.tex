\chapter{Introduction} \label{sec:introduction}
    ...
    \longsection{Overview of this Thesis}{sec:overview_of_this_thesis}
        ...
        The fourth chapter of this thesis introduces a tangent where work was performed to make the previous chapter applicable not only to static \gls{PET} data but also to dynamic \gls{PET} data. This chapter covers a method to acquire \glss{SS} from dynamic data.% and then how to apply \gls{MC} to dynamic data.
