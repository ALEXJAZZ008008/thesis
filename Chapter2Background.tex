    ...
    \longsection{PET Image Reconstruction}{sec:pet_image_reconstruction}
        ...
        \subsection{Analytic Image Reconstruction} \label{sec:analytic_image_reconstruction}
            ...
            \begin{figure}
                ...
                \captionsetup{singlelinecheck=false, justification=raggedright}
                \caption{Example of a simulated \glspl{AC} \gls{Non-TOF} \gls{BP} reconstruction, with motion and noise, with no randoms or scatters, of the thorax with a spherical lesion in the lungs. Transverse view.}
            ...
            \begin{figure}
                ...
                \captionsetup{singlelinecheck=false, justification=raggedright}
                \caption{Example of a simulated \glspl{AC} \gls{Non-TOF} \gls{FBP} reconstruction, with motion and noise, with no randoms or scatters, of the thorax with a spherical lesion in the lungs. Transverse view.}
